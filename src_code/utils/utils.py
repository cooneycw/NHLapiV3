...
def create_player_stats(player_id):
    player_stats = {
        ...
        'penalties_served': 0,
        'penalties_served_overtime': 0,
        'penalties_drawn': 0,
        'penalties_drawn_overtime': 0,
        'penalties_duration': 0,
        'penalties_duration_overtime': 0,
        'penalty_shot': 0,
        'penalty_shot_overtime': 0,
        'penalty_shot_goal': 0,
        'penalty_shot_goal_overtime': 0,
        'penalty_shot_saved': 0,
        'penalty_shot_saved_overtime': 0,
        'shot_attempt': 0,
